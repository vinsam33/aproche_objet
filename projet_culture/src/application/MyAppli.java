...
public class MyAppli {
	...
	public static void main(String[] args) {
		...
		System.out.println("Bienvenue dans le systeme de gestion de joliCit�");
		System.out.println(
				"Si vous voulez utiliser le jeu d'essai d'evenement, tapez 1 et si vous voulez vous meme �crire des evenements tapez 2");
			...
			case 1:
				...
				for (Event e : events) {
					if (!jolicite.attributeEvent(e)) {
						System.out.println("un des evenements n'a pas put etre attribu�, fermeture du programme");
						System.exit(0);
					}
				}
				rep.save(jolicite);
				System.out.println(
						"Tout les evenements ont put etre attribu� et la programmation a �t� sauvegard� en m�moire");
				jolicite.displayEvents();
				break;
			case 2:
				System.out.println("Veuillez rentrer un 'evenement, cet evenement doit etre programm� en Janvier 2021");
				do {
					...
					switch (Integer.parseInt(sc.nextLine())) {
						case 1:
							System.out.println("Veuillez �crire la date du concert au format DD/MM/YYYY");
						...
						case 2:
							System.out.println(
									"Veuillez �crire la premiere date de la piece de theatre au format DD/MM/YYYY");
							String dateTmpDebut = sc.nextLine();
							dateDebut = dateTmpDebut.split("/");
							System.out.println(
									"Veuillez �crire la derniere date de la piece de theatre au format DD/MM/YYYY");
							...
							for (int i = Integer.parseInt(dateDebut[0]); i <= Integer.parseInt(dateDebut[0]); i++) {
								calMan.add(new GregorianCalendar(Integer.parseInt(dateDebut[2]),
										Integer.parseInt(dateDebut[1]), i));
							}
							events.add(new Theatre(calMan, name, cap, duration));
							break;
					}
					System.out.println(
							"Si vous voulez rentrer un nouvel evenement tapez 1, si vous avez termniner, taper 2");
